...
if [ "$rounds" == "" ]
  then
    ...
    for ((i=1;i<=$rounds;i++)) ; do
        ...
        JVM_ARGS="-Xms512m -Xmx512m" /home/ubuntu/apache-jmeter-5.1.1/bin/jmeter -p aws_env.properties -n -t /home/ubuntu/parachuteEvaluation/jmeter/$file -l /home/ubuntu/parachuteEvaluation/results/parachuteEval_Monolith_ReverseProxy/${file%%.*}-$i.jtl
